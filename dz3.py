...
# Вариант решения 2. Т.к. условие задачи однозначно предполагает, 
# что число X в диапазоне встречатеся 1 раз, 
# создаим массив через функцию randint()

import random

print('Введите количество элементов в списке: ')
n = int(input())
list_1 = [random.randint(1, n) for _ in range(n)]
print('Наш список:')
print(*list_1, sep=' ')
print('Введите искомое число: ')
m = int(input())
